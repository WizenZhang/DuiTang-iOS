...
//  堆糖画报
//
//  Created by Wizen Zhang on 16/6/1.
...
@interface MJRefreshHeadView()
// 最后的更新时间
@property (nonatomic, strong) NSDate *lastUpdateTime;
@end

@implementation MJRefreshHeadView

+ (instancetype)head
{
    return [[MJRefreshHeadView alloc] init];
}
...
- (void)setScrollView:(UIScrollView *)scrollView
{
    ...
    // 1.设置边框
    self.frame = CGRectMake(0, - 2*MJRefreshViewHeight, scrollView.frame.size.width, MJRefreshViewHeight);
